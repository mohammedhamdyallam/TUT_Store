    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center px-4">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-8 leading-tight">
                عن <span className="text-white/95 drop-shadow-lg">توت</span>
              </h1>
              ...
              <div className="max-w-4xl mx-auto mb-10 md:mb-12">
                <p className="text-xl md:text-2xl lg:text-3xl text-white/95 leading-relaxed font-light">
                  توت هو متجر إلكتروني عصري متخصص في بيع
                  <span className="font-semibold text-white mx-2">
                    الأحذية والحقائب النسائية
                  </span>
                  عالية الجودة، نجمع بين الأناقة والراحة وأحدث صيحات الموضة.
                </p>
              </div>
      ...
      <div className="container mx-auto px-6 py-16 md:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mb-20">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
            <div className="flex items-center mb-6">
              <div className="w-12 h-12 rounded-full bg-[#6BB7C7]/10 flex items-center justify-center ml-4">
                <span className="text-2xl text-[#6BB7C7]">👠</span>
              </div>
              <h2 className="text-2xl font-bold text-gray-900">من نحن</h2>
            </div>

            <div className="space-y-4">
              <p className="text-gray-700 leading-relaxed">
                في توت، نؤمن بأن كل امرأة تستحق أحذية وحقائب أنيقة تناسب شخصيتها
                وأسلوب حياتها. يتم اختيار منتجاتنا بعناية لتقديم توازن مثالي بين
                الجودة والتصميم والسعر المناسب.
              </p>

              <p className="text-gray-700 leading-relaxed">
                نهدف لتوفير تجربة تسوق سلسة وآمنة مع دعم سريع وخدمة موثوقة لضمان
                رضا عملائنا.
              </p>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
            ...
            <div className="space-y-4">
              <p className="text-gray-700 leading-relaxed">
                نسعى لنكون الوجهة الأولى للنساء الباحثات عن أحذية وحقائب عالية
                الجودة تجمع بين الأناقة والعملية، مع الالتزام بأحدث صيحات الموضة
                العالمية.
              </p>

              <div className="mt-8 space-y-6">
                <div className="flex items-start">
                  <div className="shrink-0 w-8 h-8 rounded-full bg-[#6BB7C7] flex items-center justify-center mt-1 ml-3">
                    <svg
                  ...
                  <p className="text-gray-700">
                    منتجات مختارة بعناية من أفضل المصادر
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    خدمة عملاء استثنائية ودعم متواصل
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-2">
                    من الاثنين للجمعة، 9 صباحاً - 6 مساءً
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">القاهرة، مصر</p>
                  <p className="text-sm text-gray-500 mt-2">
                    نخدم عملاءنا في كل مكان
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-linear-to-br from-white to-gray-50 rounded-2xl p-8 shadow-lg border border-gray-100">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">
              تابعنا وكن على اطلاع
            </h2>

            <p className="text-gray-700 mb-8">
              ابق على تواصل مع توت لمعرفة أحدث المجموعات ونصائح الموضة
              والعروض الحصرية. تابعنا على وسائل التواصل الاجتماعي!
            </p>
        ...
        <div className="mt-20 text-center">
          <div className="bg-linear-to-r from-[#6BB7C7] to-[#8AC9D5] rounded-2xl p-8 md:p-12 shadow-xl">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
              جاهزة للارتقاء بأناقتك؟
            </h2>
            <p className="text-white/90 mb-8 max-w-2xl mx-auto">
              اكتشفي مجموعتنا الحصرية من الأحذية والحقائب النسائية
              المصممة للمرأة العصرية والمميزة.
            </p>
